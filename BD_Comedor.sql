...
BEGIN
	...
	DECLARE @GamerTag AS VARCHAR(40);
	...
	VALUES (@IDRol, @Nombre, @ApellidoP, @ApellidoM, @FechaNacim, @Correo, @GamerTag, @ContraseñaHash);
END;
GO
...
@FechaNacim AS INT, @Correo AS VARCHAR(40), @GamerTag AS VARCHAR(40),
@Contraseña AS VARCHAR(96)
AS
BEGIN
	INSERT INTO Empleado 
	VALUES (1, @Nombre, @ApellidoP, @ApellidoM, @FechaNacim, @Correo, @GamerTag, @Contraseña)
END;
GO
...
BEGIN
	INSERT INTO Empleado 
	VALUES (2, @Nombre, @ApellidoP, @ApellidoM, @FechaNacim, @Correo, @GamerTag, @Contraseña)
END;
GO
